...
<head>
    ...
    <link href={{asset("assets/admin/vendor/bootstrap/dist/css/bootstrap.min.css")}} rel="stylesheet">
...
<script src={{asset("assets/admin/vendor/bootstrap-select/dist/js/bootstrap.bundle.min.js")}}></script>
